...
unzip(t1, exdir = "tdata/nyc_zipcodes")
...
unzip(t2, exdir = "tdata/boundaries_2015_shp_en")

## previously retrieved Google Maps info
## see get_googlemaps_data.R
download.file("https://github.com/mac-theobio/DataViz19/blob/master/data/googlemaps.rda?raw=true", dest = "tdata/googlemaps.rda")
