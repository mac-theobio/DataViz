...
* map decoration
* representing uncertainties: @correll_value-suppressing_2018, @maceachren_visualizing_2005, @koo_geovisualizing_2018, @bolin_quantifying_2017
...
```{r redpurple, echo=FALSE, out.width="80%"}
knitr::include_graphics("pix/redpurple1.gif")
```
