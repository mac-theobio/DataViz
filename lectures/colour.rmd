...
- quantitative (continuous values)
    ...
    - sequential scales should relate sensibly to background colour
	 - or be clearly partitioned away from background
...
* small areas usually need to be saturated (dark)
