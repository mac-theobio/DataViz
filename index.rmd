...
silent <- (
    ## specifying comment="#" explicitly (passed through to readr::read_tsv())
	tsvRead(comment="#")
	%>% hux()
    ## don't know why I used print_html() rather than print_md()
    ## references ([@whatever] markup) are still rendered by pandoc,
    ## even when they live inside an HTML-formatted table
